...
{
    public class ReturnPRiskService : IReturnPRiskService
    {
        private readonly IReturnPRiskRepository _repository;
        private readonly IApiInformationRepository _repositoryApi;
        private readonly ICallAPIService _serviceApi;
        private readonly IReturnProjectService _returnProjectService;
        public ReturnPRiskService(IReturnPRiskRepository repository, IApiInformationRepository repositoryApi,
        ...
        public async Task<Dictionary<int, APIResponseDataReturnPRiskModels>> GetAllAsync(string year, string projectcode)
        {
            ...
            try
            {
                ...
                List<ReturnPRisk> newProjects = new();
                ...
                foreach (var item in resultApi.Data)
                {
                    ...
                    newProjects.Add(new ReturnPRisk
                    {
                        KeyId = keyId,
            ...
            catch (Exception ex)
            {
                ...
                return new Dictionary<int, APIResponseDataReturnPRiskModels>();
            }
        ...
        public async Task<int> BatchReturn_Risk()
        {
