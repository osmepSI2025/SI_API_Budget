...
public partial class ReturnPOutputModels
{
...
public class APIResponseDataReturnPOutputModels
{
    [JsonPropertyName("DATA_P1")]
    public string? DATA_P1 { get; set; }
...
public class ApiResponseReturnPOutputModels
{
    public int? StatusCode { get; set; }
    public string? Message { get; set; }
    public Dictionary<string, APIResponseDataReturnPOutputModels> Data { get; set; } = new();
}